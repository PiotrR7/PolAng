...
class HardMode:
    ...
    def Play():
        ...
        screenwidth = HardMode.Memory.window.winfo_screenwidth()
        screenheight = HardMode.Memory.window.winfo_screenheight()
        ...
        odp1 = tk.StringVar()
        odp1.set(HardMode.Memory.odp1)
        odp2 = tk.StringVar()
        odp2.set(HardMode.Memory.odp2)
        odp3 = tk.StringVar()
        odp3.set(HardMode.Memory.odp3)
        odp4 = tk.StringVar()
        odp4.set(HardMode.Memory.odp4)
        odp5 = tk.StringVar()
        odp5.set(HardMode.Memory.odp5)
        odp6 = tk.StringVar()
        odp6.set(HardMode.Memory.odp6)

        image = tk.Label(image=photos[photosAsStr.index(HardMode.Memory.img)], height=500, width=900).place(x=500, y=20)
        label = tk.Label(textvariable=pl, width=10, height=2).place(x=910,y=600)
        result = tk.Label(textvariable=HardMode.Memory.points, width=2, height=2).place(x=20, y=20)
        button = tk.Button(textvariable=odp1, width=40, height=2, command=lambda: HardMode.IsCorectOdp(HardMode.Memory.odp1))
        button.place(x=500, y=700)
        button = tk.Button(textvariable=odp2, width=40, height=2, command=lambda: HardMode.IsCorectOdp(HardMode.Memory.odp2))
        button.place(x=800, y=700)
        button = tk.Button(textvariable=odp3, width=40, height=2, command=lambda: HardMode.IsCorectOdp(HardMode.Memory.odp3))
        button.place(x=1100, y=700)
        button = tk.Button(textvariable=odp4, width=40, height=2, command=lambda: HardMode.IsCorectOdp(HardMode.Memory.odp4))
        button.place(x=500, y=750)
        button = tk.Button(textvariable=odp5, width=40, height=2, command=lambda: HardMode.IsCorectOdp(HardMode.Memory.odp5))
        button.place(x=800, y=750)
        button = tk.Button(textvariable=odp6, width=40, height=2, command=lambda: HardMode.IsCorectOdp(HardMode.Memory.odp6))
